...
% 前言
\input{introduction/00_01_Preface}
\clearpage

% 序
\input{introduction/00_02_Order}
\clearpage

% 凡例
\input{introduction/00_03_General}
\clearpage
...
\input{introduction/35_Introduction_to_the_New_Testament}
\clearpage

% 福音总论
\phantomsection
\addcontentsline{toc}{chapter}{福音总论}
\input{introduction/36_Gospel_Introduction}
\clearpage

% 玛窦福音引言
\phantomsection
\addcontentsline{toc}{chapter}{玛窦福音引言}
\input{introduction/37_Introduction_to_the_Matthew}
\clearpage
% 玛窦福音（玛）
\phantomsection
...
\input{introduction/45_Introduction_to_the_Galatians}
\clearpage
% 迦拉达书（迦）
\phantomsection
...
\input{introduction/51_Introduction_to_the_Titus}
\clearpage
% 弟铎书（铎）
\phantomsection
...
\input{introduction/52_Introduction_to_the_Philemon}
\clearpage
% 费肋孟书（费）
\phantomsection
...
\input{introduction/56_Introduction_to_the_Peter}
\clearpage
% 伯多禄前书（伯前）
\phantomsection
...
\input{introduction/57_123_Introduction_to_the_John}
\clearpage
% 若望一书（若一）
\phantomsection
...
\input{introduction/58_Introduction_to_the_Jude}
\clearpage
% 犹达书（犹）
\phantomsection
